...
class PendingStatusFragment : Fragment(), `in` {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        var view = inflater.inflate(R.layout.fragment_pending_status, container, false)
    ...
    fun ss(id:Int){
        val call = APIClient.service.getPending(id)
