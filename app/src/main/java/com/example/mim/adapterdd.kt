...
class adapterdd(val data: ArrayList<Production.DataK>, var l:`in`, var context: Context): RecyclerView.Adapter<adapterdd.ViewHolder>() {
...
//            context.startActivity(intent)
    ...
    fun addDatas(users: List<Production.DataK>) {
        this.data.apply {
            clear()
            addAll(users)
        }
