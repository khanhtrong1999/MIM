...
class ShippedStatusFragment : Fragment(), `in` {
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_shipped_status, container, false)
    ...
    fun ss(id:Int){
        val call = APIClient.service.getShipped(id)
